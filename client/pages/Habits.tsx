...
export default function Habits() {
  ...
  const categories = [
    { id: "all", name: "Todos", icon: Target, count: habits.length },
    {
      ...
      name: "Ejercicio",
      icon: Dumbbell,
      count: habits.filter((h) => h.category === "exercise").length,
    },
    {
      id: "hydration",
      name: "Hidratación",
      icon: Droplets,
      count: habits.filter((h) => h.category === "hydration").length,
    },
    {
      id: "finance",
      name: "Finanzas",
      icon: DollarSign,
      count: habits.filter((h) => h.category === "finance").length,
    },
    {
      id: "shopping",
      name: "Compras",
      icon: ShoppingCart,
      count: habits.filter((h) => h.category === "shopping").length,
    },
    {
      id: "custom",
      name: "Personal",
      icon: Star,
      count: habits.filter((h) => h.category === "custom").length,
    },
  ];
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Organiza, edita y supervisa todos tus hábitos desde un solo
                lugar
              </p>
            </div>
            <Button
                ...
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    {searchQuery
                      ...
                      : "Aún no has creado hábitos en esta categoría"}
                  </p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              este hábito y todo su historial de progreso.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
