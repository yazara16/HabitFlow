              ...
              <CardContent className="p-0">
                <Tabs value={activeTab} onValueChange={setActiveTab} orientation="vertical">
                  <TabsList className="flex flex-col h-auto w-full bg-transparent p-2">
                    ...
                    <TabsTrigger value="habits" className="w-full justify-start">
              ...
              <TabsContent value="notifications">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">Recibe recordatorios en tu dispositivo</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">Recibe resúmenes y recordatorios por correo</p>
                        </div>
                        <Switch
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Recordatorio para revisar tus hábitos</p>
                          </div>
                          <Switch
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Resumen de tu progreso semanal</p>
                          </div>
                          <Switch
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Celebra tus rachas y metas alcanzadas</p>
                          </div>
                          <Switch
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="reminderTime">Hora del recordatorio diario</Label>
                      <Input
                        id="reminderTime"
                        type="time"
              ...
              <TabsContent value="appearance">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div>
                        <Label className="text-base font-medium mb-3 block">Tema</Label>
                      ...
                      <div>
                        <Label className="text-base font-medium mb-3 block">Esquema de colores</Label>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Reduce el espaciado y el tamaño de elementos</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Efectos de transición y animaciones suaves</p>
                        </div>
                        <Switch
              ...
              <TabsContent value="habits">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Nuevos hábitos tendrán recordatorios habilitados</p>
                        </div>
                        <Switch
                          checked={settings.defaultReminderEnabled}
                          onCheckedChange={(checked) => updateSetting("defaultReminderEnabled", checked)}
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Ocultar automáticamente hábitos con metas alcanzadas</p>
                        </div>
                        <Switch
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="streakReset">Hora de reinicio de racha</Label>
                        <Input
                          id="streakReset"
                          type="time"
                          value={settings.streakResetTime}
                          onChange={(e) => updateSetting("streakResetTime", e.target.value)}
                        />
                        <p className="text-xs text-muted-foreground">Hora cuando se considera un nuevo día</p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select 
                          ...
                          onValueChange={(value) => updateSetting("weekStartsOn", value as any)}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
              ...
              <TabsContent value="privacy">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Controla la privacidad de tus datos y el uso de información
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Ayúdanos a mejorar la app con datos anónimos</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Permite que otros vean tu progreso general</p>
                        </div>
                        <Switch
                    ...
                    <div className="p-4 bg-muted/50 rounded-lg">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium mb-2">Sobre tu privacidad</h4>
                          <p className="text-sm text-muted-foreground leading-relaxed">
                            Tus datos personales están protegidos con encriptación de extremo a extremo. 
                      ...
                      <Card>
                        <CardContent className="p-4">
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            Descarga todos tus hábitos y progreso en formato JSON
                          </p>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              <h4 className="font-medium text-destructive mb-2">Eliminar todos los datos</h4>
                              <p className="text-sm text-muted-foreground mb-4">
                                Esta acción eliminará permanentemente todos tus hábitos, progreso y configuraciones. 
